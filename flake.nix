# flake.nix - HOPR hopr-impls Nix flake configuration
#
...
#
# Structure:
# - nix/packages/: Package definitions (hopr-impls)
# - nix/checks.nix: CI/CD quality checks
# - nix-lib (external): Rust builders, treefmt, and utilities

{
  description = "HOPR hopr-impls - Implementations of the hopr-lib API traits";
  ...
  inputs = {
    ...
    # v1.4.0 adds the code-quality metric tool chain to `mkDevShell`.
    nix-lib.url = "github:hoprnet/nix-lib/v1.4.0";
